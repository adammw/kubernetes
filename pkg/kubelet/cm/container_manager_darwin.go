...
// containerManagerImpl implements container manager on darwin.
...
func (cm *containerManagerImpl) Start(node *v1.Node,
	...
	klog.V(2).Infof("Starting Darwin container manager")
...
// NewContainerManager creates darwin container manager.
